...
tags:
  ...
  - Benchmarks
published: false
comment: "Claude Opus 4.6 reverse-engineered a benchmark to find the answer — Anthropic voluntarily disclosed this, calling it a concern about the lengths a model might go to accomplish a task."
author: "Jason Lovell"
