---
title: "BullshitBench v2 Results: Anthropic & Qwen 3.5 Lead in Bullshit Detection"
description: "Only two model families score above 60% on bullshit detection: Anthropic's latest models and Qwen 3.5. Reasoning models score lower, not higher — they build around wrong premises rather than reject them."
date: "2026-03-07"
tags:
  - AI
  - Benchmarks
